...
-> injected OpenClicky-Web widget
-> local token server
...
The agent worker owns the turn loop: receive a prospect question, query adapters, choose an intent, answer, and emit typed OpenClicky-Web actions.
