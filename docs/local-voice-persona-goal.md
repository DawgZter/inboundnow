...
- The user can speak naturally instead of using the typed fallback.
...
Do not mark the goal complete until the local voice persona works end to end and the proof matrix clearly separates real local model proof from fallback/stub/contract proof.
